...
import 'package:new_crunchies_food/features/authentication/controllers/location/state_location_controller.dart';
...
class LocationForm extends StatelessWidget {
  ...
  final controller = Get.put(StateLocationController());
      ...
      child: Column(
        children: [
          ...
          DropdownButtonFormField(
            ...
            onChanged: controller.selectedState.call,
            validator: (value) =>
