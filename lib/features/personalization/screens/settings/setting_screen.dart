...
import 'package:new_crunchies_food/data/repositories/product/product_repository.dart';
...
import 'package:new_crunchies_food/features/personalization/screens/address/widgets/added_address_list.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              SettingsBody(
                ...
                // },
                icon: Iconsax.user,
                text: MyTexts.settingTitle1,
                navIcon: Icons.chevron_right,
              ),
              ...
              SettingsBody(
                onPressed: () {
                  ...
                  if(addressController.hasAddress.value){
                    Get.to(() => const AddedAddressList());
                  } else {
                    Get.to(() => const AddressScreen());
                  }
                },
                icon: Iconsax.location,
                text: MyTexts.settingTitle2,
                navIcon: Icons.chevron_right,
              ),
              SizedBox(height: MySizes.xs - 2),
              ...
              ///loyalty
              SettingsBody(
                onPressed: () => Get.to(() => LoyaltyScreen()),
                icon: Iconsax.discount_shape,
                text: MyTexts.settingTitle4,
                navIcon: Icons.chevron_right,
              ),
              ...
              SettingsBody(
                ...
                icon: Iconsax.logout1,
                text: MyTexts.settingTitle10,
              ),
        
              ElevatedButton(onPressed: () {
                productRepository.uploadDummyDataa(MyDummyData.products);
                print('pushedddd');
              }, child: Text('Push')),
              SizedBox(height: MySizes.xs - 2),
